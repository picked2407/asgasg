                    ...
                    <div className="container">
                        <div className="items-center justify-between py-10 md:flex md:h-[400px] md:py-0">
                            <div className="heading relative mb-0 text-center ltr:md:text-left rtl:md:text-right">
                                <h4 className="!text-white">{language.privacyPolicy[currentLanguage]}</h4>
                            </div>
                            <div className="relative mt-6 md:mt-0" data-aos={isRtl ? 'fade-right' : 'fade-left'} data-aos-duration="1000">
                                ...
                                >
                                    <path
                                        ...
                                        fill="#e4541b"
                                    />
                                    <path d="M195.733 110.368L203.013 109.052L185.514 12.816L175.854 1L195.733 110.368Z" fill="#e4541b" />
                                    <path d="M174.902 1.16802L170.002 15.644L187.53 111.88L194.782 110.564L174.902 1.16802Z" fill="#e4541b" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        fill="#1d99cf"
                                    />
                                    <path d="M145.472 155.952L132.592 135.82L145.696 150.912C145.805 152.595 145.73 154.285 145.472 155.952Z" fill="#1d99cf" />
                                    <path
